...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hyderabad's top-rated immigration consultancy for Germany Opportunity Card, Australia PR, Canada PR, UK Skilled Worker & JSS programs. 1000+ successful cases, senior-led, transparent fees." },
      { name: "keywords", content: "best immigration consultancy in Hyderabad, immigration consultants Hyderabad, Germany Opportunity Card Hyderabad, Australia PR consultants Hyderabad, Canada PR consultants Hyderabad, UK Skilled Worker visa, JSS program, visa consultants Hitec City" },
