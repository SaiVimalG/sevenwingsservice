...
const orgJsonLd = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 17.4483, longitude: 78.3915 },
...
const sitelinksJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "SiteNavigationElement", position: 8, name: "About Us", url: `${SITE_URL}/about`, description: "About 7 Wings Immigration, Hi-Tech City Madhapur Hyderabad." },
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preload", as: "image", href: SITE.logoUrl, fetchPriority: "high" } as any,
