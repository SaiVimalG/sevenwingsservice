...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Best immigration consultancy in Hyderabad — senior-led visas & PR for Germany, Australia, Canada, UK and JSS. 1000+ successful cases, transparent fees." },
...
function VideoStory() {
  ...
  return (
    <div className="group relative mx-auto aspect-[4/5] w-full max-w-[340px] overflow-hidden rounded-3xl border border-black/5 bg-navy-deep shadow-elegant sm:aspect-auto sm:h-[550px] sm:max-w-[430px] lg:mx-0 lg:h-full lg:min-h-[500px] lg:max-w-none">
      ...
      <span className="pointer-events-none absolute bottom-6 left-6 z-10 rounded-full bg-navy-deep/70 px-4 py-1.5 font-display text-lg font-bold text-white backdrop-blur">Real Stories</span>
    </div>
  );
}
